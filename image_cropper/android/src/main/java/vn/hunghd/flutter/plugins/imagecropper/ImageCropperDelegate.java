...
public class ImageCropperDelegate implements PluginRegistry.ActivityResultListener {
    ...
    private void setupUiCustomizedOptions(UCrop.Options options, MethodCall call) {
        ...
        Boolean hideCropTab = call.argument("android.hide_crop_tab");
        Integer bottomControlsBackgroundColor = call.argument("android.bottom_controls_background_color");
        ...
        if (hideCropTab != null) {
            options.setHideCropTab(hideCropTab);
        }
        if (bottomControlsBackgroundColor != null) {
            options.setBottomControlsBackgroundColor(bottomControlsBackgroundColor);
        }
    }
